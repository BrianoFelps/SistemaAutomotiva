...
public class CadProdServ extends javax.swing.JFrame {
    ...
    if(DadosTemporarios.tempObject instanceof ModPrSr){
     ...
     private void inserir(){
            ...
            if (daoP.inserir(Integer.parseInt(tfId.getText()), Integer.parseInt(tfIdGs.getText()), tfNome.getText(), taDesc.getText(),  Double.valueOf(tfPreço.getText()))){
        ...
        private void alterar(){
            ...
            if (daoP.alterar(Integer.parseInt(tfId.getText()), Integer.parseInt(tfIdGs.getText()), tfNome.getText(), taDesc.getText(),  Double.valueOf(tfPreço.getText()))){
